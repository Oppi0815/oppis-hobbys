    ...
    <main className="project-page">
      ...
      <section>
        ...
        <div className="gallery" aria-label="Bilder der Honda-CB250G-Restaurierung">
          ...
          <figure><img src="/images/cb250g/motor.jpeg" alt="Motor der Honda CB250G vor der Restaurierung" /><figcaption>Motor</figcaption></figure>
          <figure><img src="/images/cb250g/raeder-und-teile.jpeg" alt="Räder und weitere Teile der Honda CB250G" /><figcaption>Räder &amp; weitere Teile</figcaption></figure>
          <figure><img src="/images/cb250g/tank.jpeg" alt="Originaltank der Honda CB250G vor der Lackierung" /><figcaption>Originaltank</figcaption></figure>
        </div>
      </section>
    </main>
  );
