...
export function MacroGallery() {
  ...
  return <>
    ...
    <section className="macro-category"><h3>Spinnen</h3><div className="gallery macro-gallery macro-previews" aria-label="Makroaufnahmen von Spinnen">{image(photos[12], 12)}{image(photos[13], 13)}</div></section>
