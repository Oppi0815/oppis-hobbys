...
export function MacroGallery() {
  ...
  return <>
    ...
    <section className="macro-category"><h3>Spinnen</h3><div className="gallery macro-gallery macro-previews" aria-label="Makroaufnahme einer Luchsspinne">{image(photos[12], 12)}</div></section>
