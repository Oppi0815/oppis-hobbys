...
export function MacroGallery() {
  ...
  return <>
    ...
    <section className="macro-category"><h3>Blumen</h3><div className="gallery macro-gallery macro-previews" aria-label="Aufnahmen von Blumen">{image(photos[19], 19)}</div></section>
