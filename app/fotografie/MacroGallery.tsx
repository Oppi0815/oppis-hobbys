...
const photos = [
  ...
  ["/images/makro/toepferwespe-nest-ei.jpg", "Papierwespe an einer Brutzelle mit Ei", "Brutzelle mit Ei", "Papierwespe aus der Familie Vespidae, Gattung Ropalidia; nach der Bestimmung im Buch wahrscheinlich Ropalidia chromis. Eine Artbestimmung allein anhand der Fotos bleibt unsicher."],
  ["/images/makro/toepferwespe-am-nest.jpg", "Papierwespe am Nest", "Am Papiernest", "Die Wespen bauten ihr Nest direkt am Haus in Forrest Hills bei Kloof, Südafrika."],
  ...
  ["/images/makro/toepferwespe-drohhaltung.jpg", "Papierwespe mit erhobenem Hinterleib", "Warnhaltung", "Beim Annähern hob die Wespe den Hinterleib als Warnung. In der Zeit am Haus wurde ich jedoch nie gestochen."],
  ["/images/makro/toepferwespe-portrait.jpg", "Portrait einer Papierwespe", "Portrait", "Die Fotos und die offene Papierwabe passen zu einer Papierwespe der Gattung Ropalidia. Ropalidia chromis ist die wahrscheinliche, aber nicht abschließend gesicherte Artbestimmung."],
