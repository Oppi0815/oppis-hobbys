  ...
  return (
    <>
      ...
      <main id="start">
        ...
        <section className="section workshop-update"><div className="section-heading"><p className="eyebrow">Werkstatt aktuell</p><h2>Neues aus der Werkstatt</h2></div><div className="workshop-grid"><div><h3>Honda CB250G · Neuaufbau begonnen</h3><p>Der Rahmen ist gepulvert, der Motor frisch überholt und wieder eingesetzt: neue Kolben, aufgebohrter und gehonter Zylinder, eingeschliffene Ventile, neue Steuerkette und eingestelltes Ventilspiel.</p><p>Jetzt beginnt der langsame Anbau. Fehlende Teile werden noch besorgt; Tank und Seitendeckel warten auf ihren Lack in <strong>Hawaiian Blue Metallic</strong>. Da die Maschine aus Dänemark kommt, aber einen Schweizer Brief hat, gehört auch die Verzollung noch zum Projekt.</p><ol className="milestones"><li className="done">Rahmen entrostet &amp; gepulvert</li><li className="done">Motor überholt &amp; eingesetzt</li><li className="current">Anbauteile &amp; Fehlteile</li><li>Lack, Verzollung &amp; Endmontage</li></ol><p className="next-step"><b>Nächster Schritt:</b> Anbauteile sortieren, fehlende Teile besorgen und den weiteren Aufbau vorbereiten.</p><a className="button" href="/projekte/cb250g">Zum Projekt</a></div><img src="/images/cb250g/neuaufbau-begonnen.png" alt="Honda CB250G mit frisch eingesetztem Motor im gepulverten Rahmen" /></div></section>
