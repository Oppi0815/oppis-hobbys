    ...
    <>
      ...
      <main id="start">
        ...
        <section id="projekte" className="section feature-section">
          ...
          <div className="split"><div className="number-panel">1976</div><div><h3>Honda CB250G</h3><p>Mein aktuelles Projekt ist die Restaurierung einer Honda CB250G von 1976. Von der Technik bis zum Lack in <strong>Hawaiian Blue Metallic</strong>: Hier sollen nach und nach Bilder, Arbeitsschritte und kleine Erfahrungen aus der Werkstatt ihren Platz finden.</p><a className="button" href="/projekte/cb250g">Zum Projekt mit Bildergalerie</a></div></div>
        ...
        <section id="ueber-mich" className="section about"><div className="section-heading"><p className="eyebrow">04 · Persönlich</p><h2>Über mich</h2></div><div className="about-layout"><img className="about-portrait" src="/images/horst-comic-v2.png" alt="Illustration eines Werkstatt-Hobbyisten" /><p className="about-text">Ich bin Horst – neugierig auf Technik, begeistert von klassischen Motorrädern und gern mit der Kamera in der Natur unterwegs. Diese Seite wächst mit meinen Projekten und soll vor allem Freude am Selbermachen zeigen.</p></div></section>
      </main>
