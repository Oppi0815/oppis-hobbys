  ...
  return (
    <>
      ...
      <main id="start">
        ...
        <section id="ueber-mich" className="section about"><div className="section-heading"><p className="eyebrow">04 · Persönlich</p><h2>Über mich</h2></div><div className="about-layout"><p className="about-text">Ich bin Horst – neugierig auf Technik, begeistert von klassischen Motorrädern und gern mit der Kamera in der Natur unterwegs. Diese Seite wächst mit meinen Projekten und soll vor allem Freude am Selbermachen zeigen.</p><img className="about-portrait" src="/images/horst-comic-v2.png" alt="Illustration eines Werkstatt-Hobbyisten" /></div></section>
      </main>
